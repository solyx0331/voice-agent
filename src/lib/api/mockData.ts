...
export const mockCalls: Call[] = [
  { 
    ...
    recording: true,
    outcome: "success",
    latency: { avg: 850, peak: 1200 },
    transcript: [
      { speaker: "ai", text: "Hello! Thank you for calling. How can I assist you today?", timestamp: "00:00" },
      { speaker: "user", text: "Hi, I'm interested in your services.", timestamp: "00:03" },
  ...
  { 
    ...
    status: "completed", 
    recording: true,
    outcome: "speech_not_recognized",
    latency: { avg: 1100, peak: 1800 }
  },
  { 
    id: "6", 
